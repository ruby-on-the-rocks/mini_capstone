...
Product.create!({supplier_id: 2, name: "WNYX Mug", price: 2, description: "Get your morning news once you wake up with a cup of joe from... well Joe. He made it with his homemade duct tape"})
...
Image.create!(product_id: 3, url: "http://static.dudeiwantthat.com/img/gear/weapons/custom-made-lightsabers-6245.jpg")
